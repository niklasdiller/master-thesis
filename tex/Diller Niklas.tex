...
\newcommand{\MS}{\variablename{Model Score}}
\newcommand{\PS}{\variablename{Performance Score}}
\newcommand{\RAS}{\variablename{Resource Awareness Score}}
...
% Document start
\begin{document}
\bstctlcite{IEEEexample:BSTcontrol} % To get rid of dashes if 2 entries in bib have same author and year
